...
export const zindabadStory = {
  ...
  opening: {
    ...
    image: {
      ...z.ascent,
      caption:
        "Moving on steep snow during the Spantik campaign — where judgment and partnership decide the day.",
    },
  },
  hunza: {
    id: "hunza",
    ...
    image: {
      ...z.peak,
      caption:
        "Spantik from the approach — the peak that shaped the horizon of his childhood and the Zindabad ascent.",
    },
  },
  training: {
    id: "training",
    ...
    image: {
      ...z.ridge,
      caption:
        "Technical ridge terrain on the Zindabad line — the kind of ground that demands real alpine schooling.",
    },
  },
  zom: {
    id: "zom",
    ...
    image: {
      ...z.partners,
      caption:
        "Shared rope on Spantik — Mueez with his climbing partner during the Zindabad ascent.",
    },
  },
  zindabad: {
    id: "zindabad",
    ...
    image: {
      ...z.routeMap,
      caption:
        "The Zindabad Route on Spantik (7,027 m) — 1,800 m of climbing, graded M5 A1, with camps marked along the east ridge.",
    },
  },
  guide: {
    id: "guide",
    ...
    image: {
      ...z.highCamp,
      caption:
        "High camp above the clouds — living and deciding at altitude on the Spantik campaign.",
    },
  },
  legacy: {
    id: "legacy",
    ...
    image: {
      ...z.cover,
      caption:
        "Zindabad on Spantik — a line that points toward a bigger future for Pakistani guiding.",
    },
  },
  gallery: {
    eyebrow: "On the route",
    title: "Frames from the Zindabad ascent.",
    description: "Selected stills from the Spantik campaign.",
    images: [
      {
        ...z.routeMap,
        caption: "Route overlay on Spantik’s east ridge.",
      },
      {
        ...z.peak,
        caption: "The peak in clear weather.",
      },
      {
        ...z.partners,
        caption: "Partners on the snow slope.",
      },
      {
        ...z.highCamp,
        caption: "High camp above the cloud sea.",
      },
      {
        ...z.ascent,
        caption: "Moving on steep snow.",
      },
      {
        ...z.ridge,
        caption: "Ridge and rock towers on the line.",
      },
    ],
  },
  cta: {
